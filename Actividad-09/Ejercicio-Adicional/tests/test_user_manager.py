...
# test verifica metodo agregar_usuario_exitoso
...
# test verifica metodo agregar_usuario_existente con hash
...
# test verifica el llamado de hash
...
# test verifica agregar usuario existente con stub
...
# test verifica inyeccion de repositorio en memoria
...
# test verifica el llamado de envio de correo
